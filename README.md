...
>
> stackstac remains functional but is not under active development. For new projects, the actively maintained alternatives are [`odc-stac`](https://github.com/opendatacube/odc-stac) and [`lazycogs`](https://developmentseed.org/lazycogs/) instead.
